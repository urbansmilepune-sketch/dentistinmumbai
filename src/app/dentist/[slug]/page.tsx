      ...
      <header style={{ background: '#fff', borderBottom: '1px solid var(--border)', position: 'sticky', top: 0, zIndex: 100 }}>
        <nav className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center' }}>
            <img src="/logo.svg" alt="DentistInMumbai.in" style={{ height: 38, width: 'auto', display: 'block' }} />
          </Link>
            ...
            <div className="profile-hero-cta" style={{ display: 'flex', flexDirection: 'column', gap: 10, minWidth: 180, paddingTop: 16 }}>
              {dentist.whatsapp && (
                <TrackedLink
                  ...
                  href={`https://wa.me/91${dentist.whatsapp.replace(/\D/g, '')}?text=Hi%20${encodeURIComponent(dentist.name)}%2C%20I%20found%20you%20on%20dentistinmumbai.in%20and%20would%20like%20to%20book%20an%20appointment.`}
