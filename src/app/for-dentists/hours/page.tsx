            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
              ...
              {hours[key]?.is_open ? (
                <>
                  ...
                  <button onClick={() => applyToAll(key)} style={{ fontSize: 11, color: 'var(--blue)', background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'var(--font-body)', padding: '4px 8px', borderRadius: 6, background: 'var(--blue-light)' } as any}>
                    Apply to all
                  </button>
                </>
              ) : (
