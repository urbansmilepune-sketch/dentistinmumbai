...
// Revenue + operational reports view. Lifted out of the standalone
// /dashboard/reports route — that route now redirects here. Renders as
// the "Revenue & Reports" sub-tab of /dashboard/analytics.
//
...
<style>
  ...
  return (
    <div>
      {/* Date filter + PDF button — the page-level h1 lives on the
          parent /analytics page; the sub-tab strip itself labels this
          view as "Revenue & Reports". */}
