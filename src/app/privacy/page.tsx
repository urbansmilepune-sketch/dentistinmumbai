...
export const metadata: Metadata = {
  title: 'Privacy Policy | dentistinmumbai.in',
  description: 'Privacy Policy for dentistinmumbai.in — how we collect, use and protect your data.',
  alternates: { canonical: 'https://www.dentistinmumbai.in/privacy' },
}

const SECTIONS = [
  {
    title: '1. Information We Collect',
    content: `When you use dentistinmumbai.in, we may collect: your name, phone number, and email address when you book an appointment or submit an enquiry; your search queries and browsing behaviour on our platform; device and browser information for analytics purposes. We do not collect payment information — all payments (if any) are processed by Razorpay directly.`,
  },
  {
  ...
  },
  {
    ...
    content: `Your data is stored securely on Supabase (PostgreSQL) hosted on AWS infrastructure in Mumbai. We use industry-standard encryption in transit (HTTPS) and at rest. Access to personal data is restricted to authorised personnel only.`,
  },
  {
    title: '6. Your Rights',
        ...
        <div className="container" style={{ maxWidth: 760 }}>
          ...
          <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 16, padding: '48px' }}>
            <p style={{ fontSize: 15, color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: 32 }}>
              dentistinmumbai.in is operated by Dentaura Prime LLP ("we", "our", "us"). This Privacy Policy explains how we collect, use, and protect your personal information when you use our platform.
            </p>
